  ...
  return (
    <div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-3 px-6 rounded-full shadow-lg hover:scale-105 transition-transform duration-200"
      >
        🤖 Chatbot
      </button>
